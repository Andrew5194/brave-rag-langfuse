...
Make these available in the environment where you launch Jupyter — export them in your shell, source a `.env` you manage yourself, use direnv, whatever you prefer.
...
| `LANGFUSE_PUBLIC_KEY` | LangFuse ingestion |
| `LANGFUSE_SECRET_KEY` | LangFuse ingestion |
